                ...
                <Element.MintCard>
                    ...
                    <div>
                        <Element.ContractDiv>
                            ...
                            <Element.ContractLink href={`https://explorer.kardiachain.io/address/${MINT_CONTRACTS.MintWithCoin1.address}`} rel="noopener noreferrer" target="_blank">{MINT_CONTRACTS.MintWithCoin1.address}</Element.ContractLink>
                        </Element.ContractDiv>
                    </div>
                </Element.MintCard>
            }
