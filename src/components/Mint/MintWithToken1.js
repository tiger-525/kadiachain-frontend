        ...
        <GridItem xl={4} lg={4} md={6} sm={12}>
            {
                ...
                <Element.MintCard>
                    <Element.ImgSection>
                        <Element.ImgItem>
                            <Element.Img src="images/mint-token1.jpg" alt="animation1" />
                        </Element.ImgItem>
                    </Element.ImgSection>
                    <Element.Section>
                    ...
                    <div>
                        <Element.ContractDiv>
                            ...
                            <Element.ContractLink href={`https://explorer.kardiachain.io/address/${MINT_CONTRACTS.MintWithToken1.address}`} rel="noopener noreferrer" target="_blank">{MINT_CONTRACTS.MintWithToken1.address}</Element.ContractLink>
                        </Element.ContractDiv>
                    </div>
                </Element.MintCard>
            }
